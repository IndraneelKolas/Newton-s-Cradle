...
chain=new Chain(bob1.body,{x:350,y:50})
chain2=new Chain(bob2.body,{x:400,y:50})
chain3=new Chain(bob3.body,{x:450,y:50})
chain4=new Chain(bob4.body,{x:500,y:50})
chain5=new Chain(bob5.body,{x:550,y:50})
roof=new Roof(450,50,300,20)
